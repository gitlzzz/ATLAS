...
- `filter_dft_calcs`: (optional, bool) Whether to filter structures based on energy and force thresholds. Default is `False`.

- `threshold_E_meV`: (optional, float) Energy threshold in meV/atom for filtering structures. Default is `1000.0`.

- `threshold_F_meV`: (optional, float) Force threshold in meV/Å for filtering structures. Default is `10000.0`.
