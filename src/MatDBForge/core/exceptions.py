...
class MissingElementError(Exception):
    ...
    def __init__(self, element, element_list, name='unknown'):
    ...
    def __str__(self):
        return (
            ...
            f"current phase element list, for phase '{self.name}' "
...
class CompositionNotMatchingElementListError(Exception):
    ...
    def __init__(self, composition, element_list, name='unknown'):
    ...
    def __str__(self):
        return (
            ...
            f" {self.name} does not match the element list."
