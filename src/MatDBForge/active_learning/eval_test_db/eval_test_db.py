...
a MatDBForge active learning workflow.
"""
...
if __name__ == '__main__':
    # The /mdb_data directory should only exist in the containerized variant
    ...
    mdb_cut.custom_print('Starting test database evaluation...', 'info', logger=logger)
    pred_energies = []
    pred_forces = []
    num_atoms_list = []
