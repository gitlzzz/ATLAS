...
import atlas.active_learning.conversion as atl_train_cnv
import atlas.core.utils as atl_ut

LOG_PATH = '/tmp'
atl_ut.init_logger(source=pl.Path(__file__).stem, log_path=LOG_PATH)
...
atl_train_cnv.gen_mace_train_aiida(
