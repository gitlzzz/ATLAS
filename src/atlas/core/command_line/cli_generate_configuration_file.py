...
from atlas.core.command_line.command_line_utils import (
    ATL_LOGO,
    get_schema,
...
def generate_template(schema, config_type):
    ...
    logo_lines = [f'# {line}' if line.strip() else '#' for line in ATL_LOGO.split('\n')]

    lines = logo_lines + [
        '#',
        '# Template file generated by atlas.',
...
def gen_default_config():
    ...
    parser = argparse.ArgumentParser(
        prog='atl_gen_configuration_file',
        description=(
